...
parser.add_argument('--decay_epoch', type=int, default=10,
                    help='decay epoch')
parser.add_argument('--traffic_file', default='./data/PEMS08.h5',
                    help='traffic file')
parser.add_argument('--SE_file', default='./data/SE(PEMS08).txt',
                    help='spatial embedding file')
parser.add_argument('--model_file', default='./data/GMAN.pkl',
                    help='save the model to disk')
parser.add_argument('--log_file', default='./data/log-pems08',
                    help='log file')
